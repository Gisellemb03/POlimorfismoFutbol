...
public class Futbolistas extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        columnas.add("Edad");
        columnas.add("Dorsal");
        columnas.add("Demarcacion");

        Vector datos = new Vector();

        for (SeleccionFutbol futbolista : Menu.integrantes) {
            if (futbolista instanceof Futbolista) {
                Vector row = new Vector();
                row.add(futbolista.getId());
                row.add(futbolista.getNombre());
                row.add(futbolista.getApellidos());
                row.add(futbolista.getEdad());
                row.add(((Futbolista) futbolista).getDorsal());
                row.add(((Futbolista) futbolista).getDemarcacion());
